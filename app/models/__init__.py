...
from .ordem_servico import STATUS_OS, STATUS_OS_LABELS, OrdemServico, os_pecas, proximo_numero_os
...
__all__ = [
    ...
    "Cliente","OrdemServico","os_pecas","STATUS_OS","STATUS_OS_LABELS","proximo_numero_os",
